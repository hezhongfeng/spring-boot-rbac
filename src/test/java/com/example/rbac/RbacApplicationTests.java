...
class RbacApplicationTests {
	...
	void addAdmin() {
		...
		// List<SimpleGrantedAuthority> authorities = Arrays.stream("1,2".split(","))
		// .map(SimpleGrantedAuthority::new).collect(Collectors.toList());

		// System.out.println(authorities);

		// System.out.println(Arrays.stream("1".split(",")).map(SimpleGrantedAuthority::new)
		...
		// // Arrays.stream("".split(",")).map(SimpleGrantedAuthority::new).collect(Collectors.toList());
